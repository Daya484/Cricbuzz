...
if response.status_code == 200:
    ...
    if all_rankings:
        ...
        csv_filename = f'icc_t20_allrounders_rankings_{timestamp}.csv'
        ...
        bucket_name = 'icc-rank_allrounder'
