...
if response.status_code == 200:
    ...
    if all_rankings:
        ...
        csv_filename = f'icc_t20_batsmen_rankings_{timestamp}.csv'
        ...
        print(f"Successfully extracted {len(all_rankings)} batsmen rankings and uploaded to GCS bucket {bucket_name} as {destination_blob_name}")
